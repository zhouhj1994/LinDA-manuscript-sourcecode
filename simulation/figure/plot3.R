...
compr.methods <- c('LinDA', 'ANCOM-BC', 'ALDEx2', 'metagenomeSeq2', 'MaAsLin2', 'Wilcoxon',
                   "DESeq2", "edgeR", "metagenomeSeq")
color.manual <- cols
linetype.manual <- c("solid", "dashed", "solid", "dashed", "solid", "dashed", "solid", "dashed", "solid")
shape.manual <- c(16, 17, 16, 17, 16, 17, 16, 17, 16)
ind <- c(1, 2, 4, 7, 11, 9, 5, 6, 8)
...
compr.methods <- c('LinDA', 'ANCOM-BC', 'ALDEx2', 'MaAsLin2', 'Spearman',
                   "DESeq2", "edgeR", "metagenomeSeq")
color.manual <- cols[-4]
linetype.manual <- linetype.manual[-4]
shape.manual <- shape.manual[-4]
ind <- ind[-4]
sample.size.label <- c("n = 50", "n = 200")
